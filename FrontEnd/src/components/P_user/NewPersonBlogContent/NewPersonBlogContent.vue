		...
		<div class="contentleft">
			<ul>
				<li
					...
					:key="index"
					@click="ChoseModel(index)"
					:style="{
						'background-color': item.chose ? 'rgb(240, 240, 240)' : '',
...
export default {
	...
	props: {
		...
		avatarUrl: {
			require: true,
			default:
				"https://img2.baidu.com/it/u=590821804,2188087390&fm=253&fmt=auto&app=138&f=JPEG?w=350&h=350",
			type: String,
		},
		username: {
			require: true,
