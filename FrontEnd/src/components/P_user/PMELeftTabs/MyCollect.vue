...
export default {
	...
	methods: {
		...
		ChangeStar(index) {
			this.collectList[index].starStation =
				!this.collectList[index].starStation;
			// 开始收藏状态修正
...
.content {
	width: 100%;
	background: white;
	background: linear-gradient(to top, rgb(247, 238, 238), rgb(192, 228, 230));
	border-radius: 5px;
}
.myCollect {
	width: 100%;
...
.myCollect .myCollectA {
	width: 100%;
	min-height: 80px;
	// background: linear-gradient(to top, rgb(235, 236, 238), rgb(192, 190, 190));
	// background: white;
