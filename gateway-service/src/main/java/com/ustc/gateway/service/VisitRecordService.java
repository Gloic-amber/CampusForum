package com.ustc.gateway.service;

import cn.hutool.core.thread.ThreadFactoryBuilder;
import com.ustc.common.web.utils.RequestUtils;
import com.ustc.gateway.filter.AuthorizeFilter;
...
/**
 * ClassName: VisitRecordService
 * Package: com.ustc.gateway.service
 * Description: 访问服务
 *
 * @Author Gloic
 * @Create 2023/11/28 17:00
 * @Version 1.0
 */
@Slf4j
@Service
public class VisitRecordService {
     ...
     * @return 访问信息，可能为空（当请求未经过{@link com.ustc.gateway.filter.VisitRecordFilter}处理时）
     */
